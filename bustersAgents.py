...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for d in livingGhostPositionDistributions:
            mostLikelyGhostPositions.append(d.argMax())

        ghostPosition = None
        ghostDistance = 9999999999
        for p in mostLikelyGhostPositions:
        ...
        for a in legal:
            ...
            d = self.distancer.getDistance(successorPosition, ghostPosition)
            if d < bestDistance:
                bestDistance = d
                bestAction = a
